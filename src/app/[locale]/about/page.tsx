      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
        ...
        <div className="grid gap-12 sm:gap-20 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="text-sm text-gray-500 sm:text-xl">
              Our flagship project is OpenDevin, an open-source software development agent that can autonomously solve software development tasks end-to-end. You can download it and use it on Github.
            </p>
            {/* Divider */}
          ...
          {/* Image */}
          <div className="min-h-[530px] overflow-hidden rounded-md bg-gray-100"><img src="https://all-hands-ai.github.io/images/illustrations/open-devin.png"></img></div>
        </div>
      </div>
    </section>
  );
