    ...
    <section>
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-semibold md:text-5xl">Our Team <span
            className="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/639156ce1c70c97aeb755c8a_Rectangle%2010%20(1).svg')] bg-cover bg-center px-4 text-white">Members</span>
          </h2>
          <p className="mx-auto mb-8 mt-4 max-w-[528px] text-[#636262] md:mb-12 lg:mb-16">Lorem ipsum dolor sit amet
            elit ut aliquam</p>
        </div>
        {/* Team Div */}
        <div
          className="mx-auto grid max-w-[1040px] grid-cols-1 justify-items-center gap-5 sm:grid-cols-2 sm:justify-items-stretch md:grid-cols-3 md:gap-4 lg:gap-6">
          {/* Item */}
          <div
            ...
            <img
              ...
              alt="" className="mb-4 inline-block h-56 w-full rounded-xl object-cover lg:h-56"/>
            ...
            <div className="mt-4 flex flex-wrap">
              <a href="#"
                ...
                <img
                  ...
                  alt="" className="inline-block h-full w-full"/>
              </a>
              <a href="#"
                 className="mr-4 flex h-8 w-8 max-w-full flex-col items-center justify-center rounded-sm bg-[#ecf2ff] px-2 font-bold text-[#1353fe]">
                <img
